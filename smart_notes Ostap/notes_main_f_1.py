...
def add_notes():
    not_name,ok= QInputDialog.getText(window,'Додати замітку','Назва замітки:')
    if not_name and ok:
        list_widget_1.addItems(not_name)
        notes[not_name]= {'text':"",'tag':""}
    writeToFaile()
